...
variables {𝕜 : Type*} {m m0 : measurable_space α} {μ : measure α}
...
lemma ae_eq_trim_of_strongly_measurable
  [topological_space γ] [metrizable_space γ] {m m0 : measurable_space β} {μ : measure β}
  (hm : m ≤ m0) {f g : β → γ}
...
lemma ae_eq_trim_iff [topological_space γ] [metrizable_space γ]
  {m m0 : measurable_space β} {μ : measure β} (hm : m ≤ m0) {f g : β → γ}
